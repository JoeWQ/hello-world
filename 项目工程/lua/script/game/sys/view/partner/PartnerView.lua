...
function PartnerView:ctor(_winName,_CurrentSelect,_selectPartnerId)
    ...
    self._CurrentSelect = tonumber(_CurrentSelect) or 1
...
function PartnerView:loadUIComplete()
    ...
    self._mcFrames={
        [1] = { frame= 3, name ="UI_shengpin", },--升品
        [2] ={ frame= 2, name ="UI_shengji",} , --升级
        [3] = { frame= 4 ,name ="UI_shengxing",}, --升星
        [4] = { frame= 1,name  = "UI_jineng",},  --技能
        [5]= {frame = 5, name= "UI_xianhun",},--仙魂
    }
