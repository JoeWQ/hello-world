...
void  BesselUI::initBesselLayer()
{
	...
	_camera = Camera::createPerspective(60.0f, winSize.width/ winSize.height,0.1f,zeye+winSize.height/2.0f + 20000);
...
void    BesselUI::updateCamera(float dt)
{
	...
	{
		_nowZeye = _nowZeye + dt * 256.0f;//速度设定为24像素
		//截断
