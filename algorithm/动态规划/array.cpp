...
#include<stdlib.h>
  ...
  {
         this->yr=(int   *)malloc(sizeof(float)*row*column);
         this->row=row;
         this->column=column;
   }
//
...
//
   void     Array::setInvalideValue(int   value)
  {
          this->invalide_value=value;
  }
//
  int        Array::getInvalideValue()
 {
