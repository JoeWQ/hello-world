...
private:
	...
	int                 _bufferBit;
private:
	bool             initWithRender(const Size &frameSize,unsigned  genType, bool useFloat);
...
public:
	 ...
	 */
	static RenderTexture *createRenderTexture(const Size &frameSize, unsigned genType,bool useFloat);
	/*
