...
void        Init(GLContext    *_context)
{
	...
	_user->object = GLProgram::createWithFile("shader/sun2/sun.vsh", "shader/sun2/sun.fsh");
...
void         Draw(GLContext	*_context)
{
	...
	GLVector4       lightColor(0.8f,0.8f,1.0f,1.0f);
	glUniform4fv(_user->lightColorLoc, 1,(float *)&lightColor);
...
_user->object->enableObject();
	...
	glUniform1i(_user->baseMapLoc, 0);
	GLVector4      lightColor2(1.0f,1.0f,1.0f,1.0f);
	glUniform4fv(_user->lightColorLoc, 1, (float *)&lightColor2);
