...
void KeyEventListener::initWithTarget(Object *target, GLKKeyPressCallback pressCallback, GLKKeyReleaseCallback releaseCallback)
{
	_eventTarget = target;
...
KeyEventListener *KeyEventListener::createKeyEventListener(Object *target, GLKKeyPressCallback pressCallback, GLKKeyReleaseCallback releaseCallback)
{
