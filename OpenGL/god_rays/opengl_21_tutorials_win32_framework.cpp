...
bool COpenGLRenderer::Init()
{
	...
	CBuffer Buffer;
	//螺旋线的方程式twist表示螺旋线的重复度,ures变量水平圆周的划分
	//vres代表在螺旋体的切面上的划分
	...
	{
		//三个点依次为沿着-Z轴依次向+Z轴递进的沿着圆周逆时针的顶点
		...
		//经过上面的循环之后,实际上x1,x2的值会被还原,因为角度被旋转了360度,此时x1,x2需要再次绕着Z轴旋转
		x1 = rotate(x1, uinc, z);
		x2 = rotate(x2, uinc, z);
